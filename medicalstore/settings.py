...
SECRET_KEY = 'django-insecure-2!wxd56e3s!b4x!5&r%3j*5l2+lt5um_xx+362kc*a-$i)w0l6'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'medicalshop',#Name of the database created for this project
...
# Define the directory where the collectstatic will collect static files for deployment.
